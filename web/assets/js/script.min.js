function testCall(e) {
    $.get("http://185.194.217.213:8080/api/v1/user/test?" + $.param(e.data)).then((function (t) {
        e.success(t), console.log(t)
    }))
}
...
function getAll() {
    $.ajax({
        ...
        dataType: "json",
        success: function (e) {
            return console.log("Data fetched"), console.log(e), e
        },
        error: function (e) {
            console.log(`Error ${e}`)
        }
...
function filtertable() {
    let e, t, n, a;
    for (e = document.getElementById("querytxt").value.toUpperCase(), t = document.getElementById("table").getElementsByTagName("tr"), a = 0; a < t.length; a++)(n = t[a].getElementsByTagName("td")[0]) && ((n.textContent || n.innerText).toUpperCase().indexOf(e) > -1 ? t[a].style.display = "" : t[a].style.display = "none")
}

function filtertable2() {
    let e, t, n, a;
    for (e = document.getElementById("querytxt2").value.toUpperCase(), t = document.getElementById("table").getElementsByTagName("tr"), a = 0; a < t.length; a++)(n = t[a].getElementsByTagName("td")[1]) && ((n.textContent || n.innerText).toUpperCase().indexOf(e) > -1 ? t[a].style.display = "" : t[a].style.display = "none")
}
let current;

function rabattSelect() {
    document.getElementById("rabatt_kundenid"), document.getElementById("rabatt_name")
}

function giveRabatt() {
    document.getElementById("rabatt_neu")
}
