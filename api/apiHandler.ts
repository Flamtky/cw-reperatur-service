...
app.post('/api/createmitarbeiter', async (req, res) => {
    ...
    try {
        let result = await DatabaseQueries.executeQuery("INSERT INTO MITARBEITER (MITARBEITERID, FIRMENID, VORNAME, NACHNAMEN, GEBURTSDATUM, STUNDENLOHN, IBAN, VERSICHERTENNUMMER, URLAUBSTAGE, ABTEILUNG, EINSTELLUNGSJAHR, AZUBI, FUHRERSCHEIN, TELEFON) \
            VALUES (:MITARBEITERID, :FIRMENID, :VORNAME, :NACHNAMEN, :GEBURTSDATUM, :STUNDENLOHN, :IBAN, :VERSICHERTENNUMMER, :URLAUBSTAGE, :ABTEILUNG, :EINSTELLUNGSJAHR, :AZUBI, :FUHRERSCHEIN, :TELEFON)",
