...
app.post('/api/createrechnung', async (req, res) => {
    ...
    try {
        let result = await DatabaseQueries.executeQuery("INSERT INTO RECHNUNG (RECHNUNGSNR, AUFTRAGSNUMMER, KUNDENID, SUMME, RECHNUNGSDATUM, ZAHLUNGSART, RABATT, LAUFZEIT, AUFPREIS, MITARBEITERARBEITZEITEN) \
